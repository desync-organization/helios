...
export function repository(overrides: Partial<RepositoryDescriptor> = {}): RepositoryDescriptor {
  return {
    ...
    allowedScanners: ["gitleaks", "trivy"],
...
export function task(overrides: Partial<Task> = {}): Task {
  ...
  return {
    ...
    consentScope: { repo: "desync-organization/helios", allowedActions: ["comment", "branch_and_pr", "security_pr"], allowedCloudProviders: ["workers_ai", "haiku", "linkup"], allowedScanners: ["gitleaks", "trivy"], privateCodeMayLeaveDevice: false, externalSecurityUploadAllowed: false, expiresAt: now + 100_000, grantedBy: "operator", consentRef: "consent-1" },
